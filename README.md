...
**The plain templates** (aviation, food, casino, AETHER) are built with plain HTML, CSS and JS, no bundler. Libraries are loaded from a CDN right in `index.html`. They all share the same structure:
